...
DEFAULT_RUNTIME_CONFIG = {
    ...
    "telegram_alert_min_score": 74,
    "telegram_alert_min_calibrated_score": 74,
...
PRESET_CONFIGS = {
    "Conservative": {
        ...
        "telegram_alert_min_calibrated_score": 80,
        "telegram_alert_cooldown_minutes": 45,
        "validation_horizon_bars": 16,
    ...
    "Aggressive": {
        ...
        "telegram_alerts_enabled": False,
        "telegram_alert_min_score": 66,
        "telegram_alert_min_calibrated_score": 66,
        "telegram_alert_cooldown_minutes": 20,
